...
public class AdminStatsResource
{
    ...
    public Response seatUsage(@CookieParam("Authorization") String authCookie)
    {
    ...
    public Response timeSlotStats(@CookieParam("Authorization") String authCookie)
    {
    ...
    public Response popularRooms(@CookieParam("Authorization") String authCookie)
    {
    ...
    public Response checkInRate(@CookieParam("Authorization") String authCookie)
    {
    ...
    public Response noShowRate(@CookieParam("Authorization") String authCookie)
    {
